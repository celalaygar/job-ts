...
const BacklogMainPage: React.FC<MainFrameProps> = () => {
                    ...
                    >
                        <div className="flex flex-col md:flex-row md:space-x-4 ">
                            <div className="w-1/2 grid justify-items-start">
                                <h5 className="text-md font-bold">{task.title}  {task.taskNumber}</h5>
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row md:space-x-4  ">
                            <div className="w-1/2 grid justify-items-start">
                                <p className="mb-2  text-sm"><strong>Oluşturulma Tarihi:</strong> {task.createdAt}</p>
                            </div>
                            <div className="w-1/2 grid justify-items-end">
